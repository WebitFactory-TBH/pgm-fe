    ...
    >
      <div className='relative'>
        ...
        <input
          {...props}
          ref={ref}
          className='block w-full rounded-md border-0 pb-2 pt-6 pl-4 text-gray-900 ring-1 ring-inset ring-gray-100 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6'
          placeholder=''
